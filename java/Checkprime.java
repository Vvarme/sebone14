 ...
 */
  ...
  *objective-this method check that given number is prime or not , if given number is prime then this method 
             return true and if the given number is not prime then this method return false;
 */
